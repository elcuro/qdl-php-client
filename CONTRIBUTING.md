...
* GitHub Issues: <https://github.com/elcuro/qdl-php-client/issues>
...
* elcuro/qdl-php-client follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  elcuro/qdl-php-client automatically runs tests for pull requests. However,
...
[github]: https://github.com/elcuro/qdl-php-client
[issues]: https://github.com/elcuro/qdl-php-client/issues
[pull requests]: https://github.com/elcuro/qdl-php-client/pulls
